...
class Application(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.img_temperature = ImageTk.PhotoImage(Image.open('../images/temperature.gif').resize(small_img_format))
        self.img_humidity = ImageTk.PhotoImage(Image.open('../images/humidity.gif').resize(small_img_format))
        self.img_soil_moisture = ImageTk.PhotoImage(Image.open('../images/soil_moisture.gif').resize(small_img_format))
...
class MainView(tk.Frame):
    """The View which is shown most of the time"""
    ...
    def update(self):
        ...
        self.glasshouse_temperature.update(greenhouse.temperature)
        self.glasshouse_humidity.update(greenhouse.humidity)
        self.glasshouse_soil_moisture.update(greenhouse.soil_moisture)
...
class DetailedView(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.controller = controller
        self.day = None
        self.weekday = tk.Label(self, text="You should never see this text", font=controller.font_underline)
        self.weekday.pack(side="top", fill="x", pady=10)
